...
import AddressSection from "./AboutYouView/AddressSection";
import CoverSection from "./AboutYouView/CoverSection";
import PersonalDetails from "./AboutYouView/PersonalDetails";
...
const AboutYou = () => {
  ...
  }, [addressData, addressError, formik, formik.values.postalCode, isAddressLoading]);
  ...
  useEffect(() => {
    ...
    if (filteredAddresses?.length === 1) {
      applySelectedAddress(filteredAddresses[0]);
    }

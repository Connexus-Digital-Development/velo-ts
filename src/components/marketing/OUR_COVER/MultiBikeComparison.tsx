...
import ComparisonTableRowMobile from "../COVER_COMPARISON/ComparisonTableRowMobile";
import CoverData from "./../COVER_COMPARISON/CoverData";
import ComparisonTableRow from "./../COVER_COMPARISON/ComparisonTableRow";
        ...
        <div className="footWrapper" style={{ marginLeft: "10px" }}>
          <div className="row">
            <div className="col-12 px-3 text-center">
              ...
              Please note prices were accurate as of March 2025 and are rounded up to the nearest pound (GBP). The cost of multi-bike insurance cover is based on one £3,000 e-bike and a £3,000 mountain bike owned by a 47 year old individual living at SW19 8TJ. Example uses Laka Core, Bikmo Go, Wiggle Essential &amp; Sundays cover levels. Laka premium calculated from 'what you will usually pay'. Quotes will vary depending on details provided.
              </p>
            </div>
          </div>
        </div>

...
import { bankValidationApi, type BankValidationData } from "@/services/api/bankValidation";
...
export const useLogPaypalError = () => {
  return useMutation({
    mutationFn: (data: any) => paymentsApi.errorPaypal(data),
    onSuccess: (data: any) => {
...
export const useValidateAppleSession = () => {
  return useMutation({
    mutationFn: (data: AppleValidationData) => paymentsApi.validateAppleSession(data),
    onSuccess: (data: any) => {
...
export const useValidateBankAccount = () => {
  return useMutation({
    mutationFn: (data: BankValidationData) => bankValidationApi.validateUkBankAccount(data),
    onSuccess: (data: any) => {
